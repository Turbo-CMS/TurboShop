...
tinymce.PluginManager.add('filemanager', function (editor) {
	...
	function resolveSettings() {
		if (tinymce.majorVersion > 5) {
			...
			settings.content_css = editor.options.get('content_css')
		} else {
			...
			settings.content_css = editor.settings.content_css
		}
	}
	...
	function filemanager(callback, value, meta) {
		...
		var dialogUrl = settings.external_filemanager_path + 'dialog.php?type=' + urltype + '&descending=' + descending + sort_by + fldr + crossdomain + '&lang=' + settings.language + '&akey=' + akey + '&content_css=' + settings.content_css;
