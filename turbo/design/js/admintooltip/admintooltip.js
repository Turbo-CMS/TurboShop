$(function() {
    ...
    $('.tooltips').on('mouseleave', function() { tooltipcanclose = true;
...
function show_tooltip() {
    ...
    tooltip.show();
    $(this).on('mouseleave', function() { tooltipcanclose = true;
    ...
    if (id = $(this).attr('data-page')) {
        tooltipcontent = "<a href='turbo/index.php?module=PageAdmin&id=" + id + "&return=" + from + "' class=admin_tooltip_edit>Редактировать</a>";
        tooltipcontent += "<a href='turbo/index.php?module=PageAdmin&return=" + from + "' class=admin_tooltip_add>Добавить страницу</a>";
    }

    if (id = $(this).attr('data-category')) {
        tooltipcontent = "<a href='turbo/index.php?module=CategoryAdmin&id=" + id + "&return=" + from + "' class=admin_tooltip_edit>Редактировать</a>";
        tooltipcontent += "<a href='turbo/index.php?module=ProductAdmin&category_id=" + id + "&return=" + from + "' class=admin_tooltip_add>Добавить товар</a>";
    }

    if (id = $(this).attr('data-brand')) {
        tooltipcontent = "<a href='turbo/index.php?module=BrandAdmin&id=" + id + "&return=" + from + "' class=admin_tooltip_edit>Редактировать</a>";
    }

    if (id = $(this).attr('data-product')) {
        tooltipcontent = "<a href='turbo/index.php?module=ProductAdmin&id=" + id + "&return=" + from + "' class=admin_tooltip_edit>Редактировать</a>";
    }

    if (id = $(this).attr('data-post')) {
        tooltipcontent = "<a href='turbo/index.php?module=PostAdmin&id=" + id + "&return=" + from + "' class=admin_tooltip_edit>Редактировать</a>";
    }

    if (id = $(this).attr('data-feature')) {
        tooltipcontent = "<a href='turbo/index.php?module=FeatureAdmin&id=" + id + "&return=" + from + "' class=admin_tooltip_edit>Редактировать</a>";
    }
