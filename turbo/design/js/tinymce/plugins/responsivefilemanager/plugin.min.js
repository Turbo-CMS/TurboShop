...
tinymce.PluginManager.add('responsivefilemanager', function (editor) {
	...
	function openmanager() {
		...
		const fileUrl = settings.external_filemanager_path + 'dialog.php?type=4&descending=' + descending + sort_by + fldr + crossdomain + '&lang=' + settings.language + '&akey=' + akey + '&content_css=' + settings.content_css;
