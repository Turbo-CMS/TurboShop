...
<form method="post" id="order" enctype="multipart/form-data" class="fn_fast_button">
                                        ...
                                        <div class="turbo_list_row">
                                            ...
                                            <div class="turbo_list_boding turbo_list_photo">
                                                ...
                                                {else}
                                                    ...
                                                    {else}
                                                        <img width="50" src="design/images/no_image.png" alt="{$product->name|escape}">
                                                    {/if}
                                                {/if}
                                            </div>
                                            <div class="turbo_list_boding turbo_list_order_name">
                                                <div class="boxes_inline">
                                                    {if $purchase->product}
                                                        ...
                                                        {if !$order->closed}
                                                            {if !$purchase->product}
                                                                <span data-hint="{$btr->product_does_not_exist|escape}" class="text_warning hint-bottom-middle-t-info-s-small-mobile  hint-anim"><i class="icon-info icons font-xs"></i></span>
                                                            {elseif !$purchase->variant}
                                                                <span data-hint="{$btr->product_variant_does_not_exist|escape}" class="text_warning hint-bottom-middle-t-info-s-small-mobile  hint-anim"><i class="icon-info icons font-xs"></i></span>
                                                            {elseif $purchase->variant->stock < $purchase->amount}
                                                                <span data-hint="{$btr->in_stock_left|escape} {$purchase->variant->stock}" class="text_warning hint-bottom-middle-t-info-s-small-mobile  hint-anim"><i class="icon-info icons font-xs"></i></span>
                                                            {/if}
                                                        {/if}
                                                    ...
                                                    <div class="hidden-lg-up mt-q">
                                                        ...
                                                        <span class="hidden-md-up text_500">{$purchase->amount} {$settings->units|escape}</span>
                                                    </div>
                                                </div>
                                                {if !$purchase->variant}
            ...
            <div class="boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="box_border_buyer">
                        ...
                        <div class="mb-1">
                            <div class="heading_label">{$btr->general_adress|escape} <a href="https://www.google.com/maps/search/{$order->address|escape}?hl={$settings->lang}" target="_blank"><i class="fa fa-map-marker"></i> {$btr->order_on_map|escape}</a></div>
                            ...
                            <div style="position:relative;">
                                ...
                                {else}
                                    <div class="fn_user_row">
                                        ...
                                        <a href="javascript:;" data-hint="Удалить товар" class="btn_close delete_grey fn_delete_user hint-bottom-right-t-info-s-small-mobile  hint-anim boxes_inline">
                                            {include file='svg_icon.tpl' svgId='delete'}
                                        </a>
                                        {if $user->group_id > 0}
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 mb-2">
            <button type="submit" class="btn btn_small btn_green float-sm-right">
