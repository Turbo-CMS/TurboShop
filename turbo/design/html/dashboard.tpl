...
<div class="row">
    <div class="col-lg-3 col-md-6 pr-0">
        <div class="boxed boxed_dashboard_green boxed_dashboard fn_toggle_wrap">
            <div class="row">
    ...
    <div class="col-lg-3 col-md-6 pr-0">
        <div class="boxed boxed_dashboard_yellow boxed_dashboard fn_toggle_wrap">
            <div class="row">
                <div class="col-lg-12 toggle_body_wrap on fn_card ">
                    <div class="row">
                        <div class="col-xs-3">
    ...
    <div class="col-lg-3 col-md-6 pr-0">
        <div class="boxed boxed_dashboard_subscribes boxed_dashboard fn_toggle_wrap">
            <div class="row">
                <div class="col-lg-12 toggle_body_wrap on fn_card ">
                    <div class="row">
                        <div class="col-xs-3">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="boxed boxed_dashboard_info boxed_dashboard fn_toggle_wrap">
            <div class="row">
                <div class="col-lg-12 toggle_body_wrap on fn_card ">
                    <div class="row">
                        <div class="col-xs-3">
...
<script>
	...
	Highcharts.theme = {
		colors: ['#2fc6f6', '#f7a35c', '#9dcf00', '#7798BF', '#aaeeee', '#ff0066', '#eeaaee', '#55BF3B', '#DF5353', '#7798BF', '#aaeeee'],
		chart: {
