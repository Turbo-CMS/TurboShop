																			...
																			<tbody>
																				<tr>
																					<td>
																						...
																						<span class="es-p5t"><em><span style="color: rgb(128, 128, 128); font-size: 12px;">{if $purchase->variant->color}{$purchase->variant->color|escape} / {/if}{$purchase->variant->name|escape}</span></em></span>
