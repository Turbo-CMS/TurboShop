{if $script_file}
	{$meta_title = "`$btr->global_script` $script_file" scope=global}
{/if}

<h1 class="h3 mb-3">{$btr->global_theme|escape} {$theme}, {$btr->global_script|escape} {$script_file}</h1>
			...
			<div class="alert alert-danger alert-dismissible fade show" role="alert">
				<div class="alert-message">
					{if $message_error == 'permissions'}
						{$btr->global_permission|escape} {$script_file}
...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb mb-3">
		<li class="breadcrumb-item"><a href="{url module=ScriptsAdmin file=null dir=null}" class="text-decoration-none text-muted">
				<i class="align-middle text-warning mt-n1" data-feather="folder"></i>
				js
			</a>
		</li>
		{if isset($smarty.get.dir) && !$script_file}
			<li class="breadcrumb-item active">
				{$smarty.get.dir}
			</li>
		{elseif isset($smarty.get.dir) && $script_file}
			<li class="breadcrumb-item active">
				<a href="/turbo/index.php?module=ScriptsAdmin&dir={$smarty.get.dir}" class="text-decoration-none text-muted">
					<i class="align-middle text-warning mt-n1" data-feather="folder"></i>
					{$smarty.get.dir}
				</a>
			</li>
					...
					<div class="card-body">
						<ul class="nav nav-pills">
							{foreach $folders as $f}
								<li class="nav-item">
									<a class="nav-link text-decoration-none {if $f == $dir}active text-white{else}text-muted{/if}" aria-current="page" href="{url module=ScriptsAdmin file=null dir=$f}">
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<h5 class="card-title mb-0">{$btr->global_scripts|escape}</h5>
			</div>
			<div class="collapse-card">
				<div class="card-body">
					<ul class="nav nav-pills">
						{foreach $scripts as $s}
							<li class="nav-item">
								<a class="nav-link text-decoration-none {if $script_file == $s}active text-white{else}text-muted{/if}" aria-current="page" href="{url module=ScriptsAdmin file=$s}">
									<i class="align-middle mt-n1" data-feather="file-text"></i>
									{$s|escape}
								</a>
							</li>
		...
		<div class="col-12">
			<div class="card mh-230px">
				<div class="card-header">
					...
					<h5 class="card-title mb-0">{$btr->global_script|escape} {$script_file|escape}</h5>
				</div>
				<div class="collapse-card">
					<div class="card-body">
						<form>
...
{js id="codemirror-js" priority=99 include=[
		...
		$(function() {
			...
			{literal}
				...
				$.ajax({
					...
					data: {'content': content, 'theme':'{/literal}{$theme}{literal}', 'script': '{/literal}{$script_file}{literal}', 'dir': '{/literal}{$dir}{literal}', 'session_id': '{/literal}{$smarty.session.id}{literal}'},
