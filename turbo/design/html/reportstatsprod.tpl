			...
			{foreach $product_report as $prod_report}
				...
				<div class="turbo_list_body_item">
					<div class="turbo_list_row">
						<div class="turbo_list_boding turbo_list_reportstats_categories">
							{$prod_report->date|date}
						</div>
						<div class="turbo_list_boding turbo_list_reportstats_products">
							<a title="{$prod_report->product_name|escape}" href="{url module=ProductAdmin id=$prod_report->product_id return=$smarty.server.REQUEST_URI}">{$prod_report->product_name}</a> {if $prod_report->variant_color}{$prod_report->variant_color|escape} / {/if} {$prod_report->variant_name}
						...
						<div class="turbo_list_boding turbo_list_reportstats_total">
							{$prod_report->price} {$currency->sign|escape}
						</div>

						<div class="turbo_list_reportstats_setting">
