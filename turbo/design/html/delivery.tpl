					...
					<div class="row d-flex">
						<div class="col-lg-10 col-md-9 col-sm-12">
							<div class="translate-container mb-3">
								...
								<input class="form-control mb-h translate-input" name="name" type="text" value="{$delivery->name|escape}">
													...
													{elseif !empty($setting->options) && $setting->options|@count == 1}
														...
														<div class="col-lg-6 d-flex align-items-center">
															<div class="form-check form-switch mb-3 mt-lg-3 mt-0">
																<input class="form-check-input me-2" type="checkbox" id="delivery-settings-{$option->value|escape}" name="delivery_settings[{$setting->variable}]" value="{$option->value|escape}" {if isset($delivery_settings[$setting->variable]) && $option->value==$delivery_settings[$setting->variable]}checked{/if}>
													...
													{else}
														<div class="col-lg-6">
															<div class="mb-3">
																...
																<input name="delivery_settings[{$setting->variable}]" class="form-control" type="text" value="{$delivery_settings[$setting->variable]|default:''|escape}" id="{$setting->variable}">
															</div>
														</div>
													{/if}
												{/foreach}
				...
				<div class="collapse-card">
					<div class="card-body">
						<ul class="checkout-images-list mb-1">
							<li class="checkout-image-item border-image-item-two {if $delivery->icon}border{/if}">
								{if $delivery->icon}
								...
								{/if}
								<div class="js-upload-image-two dropzone-block-image {if $delivery->icon}d-none{/if}">
						...
						<input class="form-control" name="code" type="text" value="{$delivery->code|escape}">
					</div>
				</div>
			</div>
		</div>
