...
<script>
	...
	function drawChartOrders() {
		...
		var options = {
			...
			backgroundColor: '#fff',
			title: '{/literal}{$btr->statistics_number_of_orders|escape}{literal}',
			isStacked: true,
			titleTextStyle: {fontSize: '18', bold: true, color: '#535c69'}
		};
	...
	function drawChart() {
		...
		var options = {
			...
			vAxis: {minValue: 0, textStyle: {fontSize: 11}},
			backgroundColor: '#fff',
			title: '{/literal}{$btr->statistics_amount_of_orders|escape}{literal}',
			isStacked: true,
			titleTextStyle: {fontSize: '18', bold: true, color: '#535c69'}
		};
