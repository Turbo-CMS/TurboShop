										...
										<div class="turbo-list-row">
											...
											<div class="turbo-list-boding turbo-list-status">
												<div class="form-check form-switch">
													<input class="form-check-input js-ajax-action {if $post->visible}js-active-class{/if}" id="id_{$post->id}" data-module="articles" data-action="visible" data-id="{$post->id}" name="visible" value="1" type="checkbox" {if $post->visible}checked="" {/if}>
