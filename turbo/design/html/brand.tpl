					...
					<div class="row d-flex">
						<div class="col-lg-10 col-md-9 col-sm-12">
							<div class="translate-container mb-3">
								...
								<input class="form-control translate-input" name="name" type="text" value="{$brand->name|escape}">
							...
							<div class="translate-container mb-3">
								...
								<input class="form-control translate-input" name="name_h1" type="text" value="{$brand->name_h1|escape}">
							</div>
							<div class="row">
								...
								{if $brand->image}
									...
									<div class="js-parent-image">
										<div class="brand-image image-wrapper js-image-wrapper text-xs-center">
											...
											{if $image|is_svg}
												<img src="../{$config->brands_images_dir}{$image}" alt="">
											{else} 
						...
						<div class="row">
							<div class="col-lg-6 col-md-6">
								<div class="translate-container mb-3">
									...
									<input name="meta_title" class="form-control js-meta-field mb-h translate-input" type="text" value="{$brand->meta_title|escape}">
								</div>
								<div class="translate-container mb-3">
									...
									<input name="meta_keywords" class="form-control js-meta-field mb-h translate-input" type="text" value="{$brand->meta_keywords|escape}">
								</div>
							</div>
							<div class="translate-container col-lg-6 col-md-6">
								...
								<textarea name="meta_description" class="form-control turbo-textarea js-meta-field translate-input">{$brand->meta_description|escape}</textarea>
							</div>
						</div>
					</div>
				</div>
