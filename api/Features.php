...
{	
	...
	public function add_feature($feature) {
        ...
        $feature['url'] = preg_replace("/[\s]+/ui", '', empty($feature['url']));
	...
	public function get_product_options($product_id)
	{
		...
		$query = $this->db->placehold("SELECT f.id as feature_id, f.name, po.value, po.product_id, po.translit, $lang_sql->fields FROM __options po LEFT JOIN __features f ON f.id=po.feature_id $lang_sql->join
