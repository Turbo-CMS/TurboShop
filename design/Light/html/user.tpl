...
{if $error}
    <div class="alert alert-danger" role="alert">
        ...
        {elseif $error == 'user_exists'}
            {$lang->user_with_this_email_is_already_registered}
        {else}
            {$error}
        {/if}
    </div>
...
<div class="col-md-6 offset-md-3">
    <form class="form-horizontal mt-4" role="form" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control" data-notice="Введите телефон" placeholder="Введите телефон" value="{$phone|escape}" name="phone" maxlength="255" type="text" />
        </div>
        <div class="form-group">
