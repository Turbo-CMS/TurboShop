...
{if $email_sent}
    <h1 class="my-4">{$lang->an_email_has_been_sent_to_you}</h1>
    <div class="alert alert-success" role="alert">
        {$email|escape} - {$lang->password_recovery_email_has_been_sent}
    </div>
{else}
            ...
            <div class="card-body">
                <form autocomplete="off" method="post" id="loginForm" class="form" role="form">
                    <div class="form-group">
                        ...
                        <span class="form-text small text-muted" id="helpResetPasswordEmail">{$lang->enter_the_email_you_provided_during_registration}</span>
                    </div>
                    <div class="form-group">
