...
{if $comments}
	...
	<div class="card p-3 mt-3 d-none d-md-block">
		<div class="d-flex align-items-center">
			<div class="me-auto">
				<p class="card-text">{$lang->leave_review_store|escape}</p>
			</div>
				...
				<div class="modal-body">
					<form class="form-horizontal needs-validation mt-1" role="form" method="post" novalidate>
						...
						{if !$smarty.session.admin == 'admin'}
							<div class="rating">
								<label class="form-label">{$lang->global_rating|escape}</label>
...
{else}
	{* Title *}
	<h2 class="h5 fw-bold my-3">{$lang->leave_review|escape}</h2>
