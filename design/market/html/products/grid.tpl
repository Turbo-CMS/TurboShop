<div class="card card-product-grid border-0 rounded-0 border-end border-bottom product products-tile">
				...
				{if $product->image}
					<a class="image text-decoration-none" href="{$lang_link}products/{$product->url}">
						{if $product->images|count > 1}
							<img class="first-image" data-src="{$product->image->filename|resize:240:240}" src="design/{$settings->theme|escape}/images/lazy.svg" alt="{$product->name|escape}">
							<img class="second-image" data-src="{$product->images[1]->filename|resize:240:240}" src="design/{$settings->theme|escape}/images/lazy.svg" alt="{$product->name|escape}">
						{else}
							<img data-src="{$product->image->filename|resize:240:240}" src="design/{$settings->theme|escape}/images/lazy.svg" alt="{$product->name|escape}">
						{/if}
					</a>
				{else}
