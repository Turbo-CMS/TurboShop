...
('162','global_price','Цена','Price','Ціна'),
...
('197','canceled','отменен','canceled','скасоване'),
...
('223','global_payment','Оплата','Payment','Оплата'),
...
('263','subscribe_newsletter','Подпишитесь на наши новости','Subscribe to our news','Підпишіться на наші новини'),
...
('256','faq_name','Часто задаваемые вопросы','FAQ','Часті питання'),
('257','no_faqs_found','Вопросы не найдены','No questions found','Запитання не знайдено'),
('258','all_categories','Все категории','All categories','Усі категорії'),
('259','ready_to_ship','Готов к отправке','Ready to ship','Готовий до відправлення'),
('260','user_login_button',' Войдите в личный кабинет ','Log in to your personal account','Увійдіть до особистого кабінету'),
('261','user_login_text',' Войдите, чтобы получать рекомендации, персональные бонусы и скидки. ','Log in to receive recommendations, personal bonuses and discounts.','Увійдіть, щоб отримувати рекомендації, персональні бонуси та знижки.'),
('262','social_networks','Мы в социальных сетях','We are on social networks','Ми у соціальних мережах'),
('264','product_details','Все о товаре','Product details','Усе про товар'),
('265','customer_reviews','Отзывы покупателей о','Customer reviews about','Відгуки покупців про'),
('266','leave_review','Оставить отзыв','Leave a review','Залишити відгук'),
('267','global_reviews','Отзывы','Reviews','Відгуки'),
('268','first_review','Будьте первым, кто оставит отзыв о товаре','Be the first to leave a review about the product','Будьте першим, залиште відгук про товар'),
('269','leave_your_review','Оставьте свой отзыв об этом товаре','Leave your review about this product','Залиште свій відгук про цей товар'),
('270','write_review','Написать отзыв','Write a review','Написати відгук'),
('271','cancel','Отменить','Cancel','Скасувати'),
('272','rate_product','Оцените товар','Rate the product','Оцініть товар'),
('273','send_reply','Отправить ответ','Send reply','Надіслати відповідь'),
('274','more_details_product','Подробнее о товаре','More details','Докладніше про товар'),
('275','watch_youtube','Смотреть на YouTube','Watch on YouTube','Дивитися на YouTube'),
('276','review_1','отзыв','review','відгук'),
('277','review_2','отзывов','reviews','відгуків'),
('278','review_3','отзыва','reviews','відгуки'),
('279','found','Найдено','Found','Знайдено'),
('280','global_product','Товар','Product','Товар'),
('281','global_product_2','товаров','products','товарів'),
('282','global_product_3','товара','product','товара'),
('283','global_product_1','товар','product','товар'),
('284','global_search','Поиск','Search','Пошук'),
('285','global_filters','Фильтры','Filters','Фільтри'),
('286','global_show','Показать','Show','Показати'),
('287','show_more','Показати ще','Show more','Показати ще'),
('288','first_comment','Будьте первым, кто оставит комментарий','Be the first to leave a comment','Будьте першим, хто залишить коментар'),
('289','leave_comment','Оставьте свой комментарий','Leave your comment','Залишіть свій коментар'),
('290','write_comment','Написать комментарий','Write a comment','Написати коментар'),
('291','global_review','Отзыв','Review','Відгук'),
('292','enter_your_review','Введите отзыв','Enter your review','Введіть відгук'),
('293','global_categories','Категории','Categories','Категорії'),
('294','global_tags','Теги','Tags','Теги'),
('295','last_articles','Последние статьи','Last articles','Останні статті'),
('296','placing_an_order','Оформление заказа','Placing an order','Оформлення замовлення'),
('298','promo_codes','Промокоды','Promo codes','Промокоди'),
('299','for_payment','К оплате','For payment','До оплати'),
('300','confirm_order','Заказ подтверждаю','I confirm the order','Замовлення підтверджую'),
('301','return_to_home','Вернуться на главную','Return to home','Повернутися на головну'),
('302','global_rating','Рейтинг','Rating','Рейтинг'),
('303','leave_review_store','Оставьте свой отзыв про наш магазин','Leave your review about our store','Залишіть свій відгук про наш магазин'),
('304','order_number','Номер заказа','Order number','Номер замовлення'),
('305','global_date','Дата','Date','Дата'),
('306','product_added','Товар добавлен в корзину','Product added to cart','Товар доданий до кошика'),
('307','global_open','Открыть','Open','Відкрити'),
('308','global_checkout','Оформить','Checkout','Оформити'),
('309','continue','Продолжить','Continue','Продовжити'),
('310','subscribe_title','Оставьте email и получайте первыми информацию о старте распродажи','Leave your email and be the first to receive information about the start of the sale','Залиште email та отримуйте першими інформацію про старт розпродажу'),
('311','delivery_methods','Способы доставки','Delivery methods','Способи доставки'),
('312','payment_methods','Способы оплаты','Payment methods','Способи оплати'),
('313','delivery_methods_list','<li>Самовывоз из службы доставки</li>\r\n<li>Курьер</li>\r\n<li>Самовывоз из магазина</li>\r\n<li>Другие транспортные службы</li>','<li>Self-pickup from the delivery service</li>\r\n<li>Courier</li>\r\n<li>Pick up from the store</li>\r\n<li>Other transport services</li>','<li>Самовивіз із служби доставки</li>\r\n<li>Кур\'єр</li>\r\n<li>Самовивіз з магазину</li>\r\n<li>Інші транспортні служби</li>'),
('314','payment_methods_list','<li>Наличными при получении</li> \r\n<li>Безналичный перевод</li>\r\n<li>Visa</li>\r\n<li>Mastercard</li>','<li>Cash on delivery</li> \r\n<li>Non-cash transfer</li>\r\n<li>Visa</li>\r\n<li>Mastercard</li>','<li>Готівкою при отриманні</li>											<li>Безготівковий переказ</li>\r\n<li>Visa</li>\r\n<li>Mastercard</li>');
