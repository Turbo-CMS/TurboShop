						...
						<div class="form">
							...
							<form id="registraion-page-form" class="validate" method="post" name="regform" enctype="multipart/form-data" novalidate="novalidate">
								<div class="form-body">
									...
									<div class="form-group fill-animate">
										<label class="font_14" for="input_PERSONAL_ADDRESS">{$lang->address|escape}</label>
										<div class="input">
											<input size="30" type="text" id="input_PERSONAL_ADDRESS" name="address" class="form-control" value="{$address|escape}">
										</div>
										<div class="text_block font_13"></div>
									</div>
									<div class="form-group fill-animate ">
