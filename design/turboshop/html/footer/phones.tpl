		...
		<div class="phones__inner phones__inner--with_dropdown phones__inner--big fill-theme-parent">
			...
			<div class="phones__dropdown phones__dropdown--top">
				...
				<div class="dropdown dropdown--relative">
					...
					<div class="phones__dropdown-item">
						<div class="address__title phones__dropdown-title">{$lang->address}</div>
						<div class="phones__dropdown-value">
							<div class="address__text font_short address__text--large">{$lang->office}</div>
						</div>
					</div>
					<div class="phones__dropdown-item">
						<div class="schedule__title phones__dropdown-title">{$lang->operating_mode}</div>
						<div class="phones__dropdown-value">
