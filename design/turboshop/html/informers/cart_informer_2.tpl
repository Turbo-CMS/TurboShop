<div class="basket top">
	{if $cart->total_products>0}
		<a rel="nofollow" title="{$lang->index_cart|escape}" href="{$lang_link}cart/" class="fill-theme-hover light-opacity-hover dark_link flexbox flexbox--direction-column flexbox--align-center fill-dark-light-block no-shrinked">
			...
			<span class="header__icon-name header-cart__name menu-light-text banner-light-text">{$lang->index_cart|escape}</span>
		</a>
											...
											<div class="line-block line-block--20 line-block--align-normal">
												...
												<div class="line-block__item flex-1">
													<div class="dropdown-product__item-info">
														...
														<a class="product-remove dropdown-product__item-remove remove fill-dark-light-block fill-theme-use-svg-hover" href="{$lang_link}cart/remove/{$purchase->variant->id}" title="{$lang->delete|escape}">
							...
							<div class="foot dropdown dropdown--relative dropdown-product-foot">
								...
								<div class="buttons">
									<div class="wrap_button">
										<a href="{$lang_link}cart" class="btn btn-default btn-wide"><span>{$lang->go_to_cart|escape}</span></a>
									</div>
								</div>
							</div>
						</div>
