					...
					<div class="detail-gallery-big swipeignore image-list__link">
						<div class="detail-gallery-big-inner">
							...
							<div class="btn-wrapper">
								<a href="{$lang_link}products/{$product->url}" class="btn btn-default btn-sm btn-transparent-border btn-wide js-replace-more" title="{$lang->more_details_product}">
									<span>{$lang->more_details_product}</span>
								</a>
							</div>
						</div>
					</div>
												...
												<div class="line-block line-block--20 flexbox--wrap js-popup-info">
													...
													{if $product->variant->sku}
														<div class="line-block__item font_13 color_999">
															<span class="article">
																{$lang->sku}&nbsp;<span class="js-replace-article" data-value="{$product->variant->sku}">{$product->variant->sku}</span>
															</span>
														</div>
													{/if}
												</div>
