<div class="js-catalog__wrapper catalog-list__wrapper grid-list__item grid-list-border-outer js-infinite product">
	<div class="catalog-list__item shadow-hovered shadow-hovered-f600 shadow-no-border-hovered side-icons-hover bg-theme-parent-hover color-theme-parent-all border-theme-parent-hover js-popup-block">
		<form class="variants" action="{$lang_link}cart">
			<div class="catalog-list__inner flexbox flexbox--direction-row height-100" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product">
				...
				<meta itemprop="description" content="{$product->annotation|escape}">{/if}
				...
				<div class="catalog-list__info flex-1 flexbox flexbox--direction-row" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
						...
						<div class="catalog-list__info-inner">
							...
							<div class="catalog-list__info-tech">
								<div class="line-block line-block--12 flexbox--wrap js-popup-info">
									...
									<div class="line-block__item font_13 js-status-container" data-stock="{$lang->not_available}" data-default="{$lang->in_stock}">
									...
									{foreach $product->features|@array_slice:0:5 as $f}
										{if !$f->is_color}
											<div class="properties__item font_14 js-prop-replace">
												<span class="properties__title js-prop-title">{$f->name}</span>
							...
							{/if}
							{if isset($product->related_products) && $product->related_products || $product->variants|count > 1}
