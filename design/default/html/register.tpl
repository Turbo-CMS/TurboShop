...
<div class="col-md-6 offset-md-3">
	...
	<div class="card card-outline-secondary">
		...
		<div class="card-body">
			<form class="form" role="form" autocomplete="off" id="FormValidation" novalidate="" method="post">
				<div class="mb-3">
					<label for="name">{$lang->name}</label>
					<input type="text" class="form-control" id="name" name="name" value="{$name|escape}" maxlength="255" id="uname1" required="">
					<div class="invalid-feedback">{$lang->enter_your_name}</div>
				</div>
				<div class="mb-3">
					<label for="email">Email</label>
					<input type="text" class="form-control" id="email" required="" name="email" value="{$email|escape}" maxlength="255">
				...
				<div class="mb-3">
					...
					<input type="password" class="form-control" id="password" required="" autocomplete="new-password" name="password" value="">
				...
				{if $settings->captcha_register}
					<div class="row mt-4">
						...
						<div class="col-sm-6 pb-3">
							<input class="form-control" type="text" name="captcha_code" required="" placeholder="{$lang->enter_captcha}" value="" autocomplete="off" />
				...
				<div class="mt-1">
					...
					<input type="submit" class="btn btn-success btn-lg float-end" id="btnValidation" name="register" value="{$lang->send}">
				</div>
			</form>
		</div>
	</div>
