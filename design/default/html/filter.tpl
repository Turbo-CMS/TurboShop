					...
					<div class="card-body">
						{foreach $category->brands as $b}
							<label class="form-check">
								<input type="checkbox" class="form-check-input" onclick="location.href = '{furl params=[brand=>$b->url, page=>null]}'" value="" {if isset($brand->id) == $b->id || isset($smarty.get.b) && in_array($b->id,$smarty.get.b)}checked{/if}>
					...
					<div class="card-group-item">
						...
						<div class="filter-content collapse show" id="collapse{$f->id}">
							<div class="card-body">
								{foreach $f->options as $k=>$o}
									<label class="form-check">
										<input class="form-check-input" type="checkbox" onclick="location.href = '{furl params=[$f->url=>$o->translit, page=>null]}'" value="" {if isset($smarty.get.{$f@key}) && in_array($o->translit,$smarty.get.{$f@key})}checked{/if}>
										<span class="form-check-label">
											{$o->value|escape}
										</span>
									</label>
