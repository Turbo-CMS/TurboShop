    ...
    {if $cart->purchases}
        <div class="col-lg-12 mt-2">
            <div class="float-right">
                <a class="btn btn-primary btn-sm" href="{url empty=1}"><i class="far fa-trash-alt"></i> <span>{$lang->empty_trash}</span></a>
            </div>
        </div>
    {/if}
</div>
    ...
    {if $cart->purchases}
        <form method="post" id="loginForm" name="cart">
                ...
                <tbody>
                    {foreach $cart->purchases as $purchase}
                        <tr>
                            ...
                            <td data-title="{$lang->delete}"><a href="{$lang_link}cart/remove/{$purchase->variant->id}"><i class="far fa-trash-alt"></i></a></td>
                        </tr>
                    {/foreach}
                </tbody>
            </table>
            ...
            <div class="form-group">
                ...
                <input name="phone" id="order_phone" class="form-control" type="text" value="{$phone|escape}" placeholder="{$lang->enter_phone_number}" />
            </div>
            <div class="form-group">
