...
{if $featured_products}
    <header class="section-heading">
        <a href="{$lang_link}featured" class="btn btn-outline-primary float-right">{$lang->see_all}</a>
...
{if $new_products}
    <header class="section-heading">
        <a href="{$lang_link}new" class="btn btn-outline-primary float-right">{$lang->see_all}</a>
...
{if $discounted_products}
    <header class="section-heading">
        <a href="{$lang_link}sale" class="btn btn-outline-primary float-right">{$lang->see_all}</a>
...
{if $hit_products}
    <header class="section-heading">
        <a href="{$lang_link}hit" class="btn btn-outline-primary float-right">{$lang->see_all}</a>
                ...
                {if $c->visible}
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a data-category="{$c->id}" class="title" href="{$lang_link}catalog/{$c->url}">{$c->name|escape}</a>
                            </div>
                            {if $c->subcategories}
