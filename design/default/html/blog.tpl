			...
			<article itemprop="blogPosts" itemscope itemtype="http://schema.org/BlogPosting">
				...
				<div class="card-body">
					...
					<div class="btn-group" role="group" aria-label="Blog group">
						<a class="btn btn-link text-muted" href="{$lang_link}blog/{$post->url}"><i class="far fa-comment"></i><span class="badge text-muted text-decoration-none">{$post->comments}</span></a>
